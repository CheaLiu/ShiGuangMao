...
import com.yizhipin.usercenter.data.response.UploadImage;
...
public class UploadUtil {
    ...
    private void toUploadFile(File file, String fileKey, String RequestURL,
        ...
        try {
            ...
            conn.setRequestProperty("ic_mine-agent", "Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1; SV1)");
 ...
 */
    ...
    private void sendMessage(int responseCode, String responseMessage) {
        ...
        UploadImage gson = new Gson().fromJson(responseMessage, UploadImage.class);
        onUploadProcessListener.onUploadDone(responseCode, gson.getData());
    }
